...
Shader "Shadero Customs/orb_red"
{
Properties
{
...
OffsetUV_X_1("OffsetUV_X_1", Range(-1, 1)) = -0.082
OffsetUV_Y_1("OffsetUV_Y_1", Range(0, 1)) = -0.173
OffsetUV_ZoomX_1("OffsetUV_ZoomX_1", Range(0.1, 10)) = 1
OffsetUV_ZoomY_1("OffsetUV_ZoomY_1", Range(0.1, 10)) = 1.088
...
float4 _DisplacementPack_1 = DisplacementPack(ZoomUV_2,DisplacementPack_1,-0.002,-0.202,-1.218,1,1);
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,_DisplacementPack_1.r*_DisplacementPack_1.a,0,-0.104);
...
float4 _DisplacementPack_2 = DisplacementPack(FishEyeUV_1,DisplacementPack_2,-0.289,0.219,0.079,1,1);
...
NewTex_5.r += 2.2;
_DisplacementPack_2 = lerp(_DisplacementPack_2,_DisplacementPack_2*_DisplacementPack_2.a + NewTex_5*NewTex_5.a,0.416);
float4 NewTex_3 = tex2D(_NewTex_3, i.texcoord);
float4 NewTex_4 = tex2D(_NewTex_4,OffsetUV_1);
NewTex_3 = lerp(NewTex_3,NewTex_3 * NewTex_4,0.373);
float4 MaskRGBA_1=_DisplacementPack_2;
MaskRGBA_1.a = lerp(NewTex_3.r, 1 - NewTex_3.r ,0);
float4 NewTex_2 = tex2D(_NewTex_2, i.texcoord);
float4 OperationBlend_1 = OperationBlend(MaskRGBA_1, NewTex_2, 1); 
float4 NewTex_1 = tex2D(_NewTex_1, i.texcoord);
float4 OperationBlend_2 = OperationBlend(OperationBlend_1, NewTex_1, 1); 
float4 HdrCreate_1 = HdrCreate(OperationBlend_2,0.9);
